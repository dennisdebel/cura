...
#3d stego test point...to be obfuscated? 
#get path to saved gcode? inject own?
with open("pythontest", "w") as text_file:
    text_file.write("win")
#end of injection test point
def main():
	"""
	Main Cura entry point. Parses arguments, and starts GUI or slicing process depending on the arguments.
	"""
	# with open("pythontest2", "w") as text_file:
	# 	text_file.write("win")
